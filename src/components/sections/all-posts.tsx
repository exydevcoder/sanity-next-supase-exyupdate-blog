...
import { BlogCard } from '../reuseable/blog-card';
...
export default function AllPostsSection() {
  const { data, error, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading } = useInfinitePosts(9); // Load 9 posts at a time
  ...
  return (
    <section aria-labelledby="all-posts-heading" className="container">
      <ComponentTitle title="All posts" className="!text-xl font-semibold" />
